...
<head>
	...
	<link href="<c:url value = "resources/css/joinAgree.css?ver=2/"/>" rel="stylesheet">
...
<div class="incontent" >
	...
	<div class="stepbox type02">
		<ul>
			<li class="step01 on" style="background:#E60012;">
	...
	<form name="joinAgreeUser" action="joinAgreeUser" method="post">
		...
		<div class="clause_wrap">
			...
			<div class="clause_box">
				...
				<dt>제 1 조 (목적)</dt>
				<dd>
				본 약관은 (주)SHOES CUSTOM(이하 “회사”라 함)이 운영하는 SHOES CUSTOM 서비스(이하 “서비스”라 함)의 이용과 관련하여 회사와 이용자 및 이용자간의 권리, 의무 및 책임사항, 서비스의 이용조건 및 절차, 기타 필요한 사항을 규정함을 목적으로 합니다. SHOES CUSTOM 서비스라 함은 회사가 제공하는 “SHOES CUSTOM” 브랜드를 사용하는 서비스를 말합니다. SHOES CUSTOM 서비스를 이용하시거나 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영정책을 확인하거나 동의하게 되므로, 조금만 시간을 내서 주의 깊게 살펴봐 주시기 바랍니다.
				</dd>
				<dt>제2조 (정의)</dt>
				<dd>
				<ol>
				...
				<li>2.        서비스: 구현되는 단말기(PC, 모바일, 태블릿 PC등의 각종 유무선 장치를 포함)와 상관없이 이용자가 이용할 수 있는 SHOES CUSTOM 서비스를 의미합니다.</li>
			...
			<div class="clause_box">
				<p class="clause_tit">(주)SHOES CUSTOM 서비스 제공을 위하여 아래와 같이 개인정보를 수집 및 이용합니다.</p>
				<dl>
